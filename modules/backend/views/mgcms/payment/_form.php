...
<div class="payment-form">
    ...
    <div class="row">
        ...
        <?= $form->field6md($model, 'is_company')->switchInput() ?>

        <?= $form->field6md($model, 'tax_id_type')->textInput(['placeholder' => $model->getAttributeLabel('tax_id_type')]) ?>

        <?= $form->field6md($model, 'pit_transfer_form')->textInput(['placeholder' => $model->getAttributeLabel('pit_transfer_form')]) ?>
        <?= $form->field6md($model, 'notarial_act_city')->textInput(['placeholder' => $model->getAttributeLabel('notarial_act_city')]) ?>
        <?= $form->field6md($model, 'notarial_act_day')->textInput(['placeholder' => $model->getAttributeLabel('notarial_act_day')]) ?>
        <?= $form->field6md($model, 'notarial_act_hour')->textInput(['placeholder' => $model->getAttributeLabel('notarial_act_hour')]) ?>
        <?= $form->field6md($model, 'notarial_act_day2')->textInput(['placeholder' => $model->getAttributeLabel('notarial_act_day2')]) ?>
        <?= $form->field6md($model, 'notarial_act_hour2')->textInput(['placeholder' => $model->getAttributeLabel('notarial_act_hour2')]) ?>
